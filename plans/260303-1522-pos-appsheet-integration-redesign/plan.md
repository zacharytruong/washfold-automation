...
| # | Phase | Status | File |
|---|---|---|---|
| 01 | Verify POS cancellation status code | `pending` | [phase-01](./phase-01-verify-cancellation-status.md) |
| 02 | Update status-mapper | `pending` | [phase-02](./phase-02-update-status-mapper.md) |
| 03 | Simplify google-sheets service | `pending` | [phase-03](./phase-03-simplify-google-sheets.md) |
| 04 | Update POS webhook handler | `pending` | [phase-04](./phase-04-update-pos-webhook.md) |
| 05 | Update AppSheet webhook handler | `pending` | [phase-05](./phase-05-update-appsheet-webhook.md) |
| 06 | Update tests | `pending` | [phase-06](./phase-06-update-tests.md) |
